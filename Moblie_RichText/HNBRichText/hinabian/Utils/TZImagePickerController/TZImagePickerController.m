...
- (instancetype)initWithSelectedAssets:(NSMutableArray *)selectedAssets selectedPhotos:(NSMutableArray *)selectedPhotos index:(NSInteger)index{
    ...
    if (self) {
        if (_isIdeaBack) {
            ...
            [previewVc setOkButtonClickBlockWithPreviewType:^(NSArray<UIImage *> *photos, NSArray<TZAssetModel *>*models, NSArray *assets, BOOL isSelectOriginalPhoto) {
            ...
            [previewVc setBackButtonClickBlockWithPreviewType:^(NSArray<TZAssetModel *>*models, NSArray *assets) {
