...
- (void)drawXAxis{
    ...
    for (NSInteger cou = 0; cou < self.xMarks.count; cou ++) {
        ...
        xLable.backgroundColor = [UIColor redColor];
        ...
        if (self.gridTyle == YHChartLineGridHorizontalAndVertical) {
            ...
            if (0 == cou) { // 轴线
                shapeLayer.strokeColor = [UIColor greenColor].CGColor;//self.axisColor;
                shapeLayer.lineWidth = self.axisWidth;
            }else{
                shapeLayer.strokeColor = [UIColor cyanColor].CGColor;//self.gridLineColor;
