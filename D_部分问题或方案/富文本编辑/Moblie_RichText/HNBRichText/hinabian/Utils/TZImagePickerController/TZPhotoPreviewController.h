...
@property (nonatomic, copy) void (^backButtonClickBlockWithPreviewType)(NSArray<TZAssetModel *> *models,NSArray *assets);
@property (nonatomic, copy) void (^okButtonClickBlock)(BOOL isSelectOriginalPhoto);
@property (nonatomic, copy) void (^okButtonClickBlockWithPreviewType)(NSArray<UIImage *> *photos,NSArray<TZAssetModel *> *models,NSArray *assets,BOOL isSelectOriginalPhoto);
