...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate isIdeaBack:(BOOL)isIdeaBack;
...
@property (nonatomic, strong) NSMutableArray<TZAssetModel *> *showModels;
...
@property (nonatomic, copy) void (^didBackPickingPhotosHandle)(NSArray<TZAssetModel *> *models,  NSArray *assets);
@property (nonatomic, copy) void (^didFinishPickingPhotosWithModelHanled)(NSArray<UIImage *> *photos, NSArray<TZAssetModel *> *models,  NSArray *assets,BOOL isSelectOriginalPhoto);
